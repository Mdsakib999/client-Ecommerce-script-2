                      ...
                      <div className="w-full text-center">
                        ...
                        <div className="pt-3">
                          <button
                            ...
                            className="w-full  bg-gray-200 cursor-pointer rounded-full py-2 px-4 font-semibold text-sm flex items-center justify-center space-x-2 transition-colors hover:bg-gray-700 hover:text-white"
                          >
