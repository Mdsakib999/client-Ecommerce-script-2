...
export default function About() {
  return (
    <div className="max-w-7xl mx-auto p-12">
      <div className="relative mb-16 min-h-[600px] bg-no-repeat bg-cover bg-center flex items-center justify-center text-white" style={{ backgroundImage: `url(${banner})` }}>
        <div className="absolute inset-0 bg-black opacity-60"></div> 
        <div className="z-10 flex items-center flex-col gap-4 text-center">
          <h1 className="text-6xl text-white capitalize">About for Bacola</h1>
